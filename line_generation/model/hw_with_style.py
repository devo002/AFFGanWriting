...
class HWWithStyle(BaseModel):
    def __init__(self, config):
        ...
        if 'char' in style_type:
            ...
            self.style_extractor = CharStyleEncoder(input_dim, dim, style_dim, char_dim, char_style_dim, norm, activ, pad_type, num_class, 
                    ...
                    window=window,
                    small=small)
    #         self.style_extractor = CharStyleEncoder(
    #         input_dim, dim, style_dim, char_dim, char_style_dim, norm, activ, pad_type, num_class,
    #         global_pool=global_pool,
    #         average_found_char_style=average_found_char_style,
    #         num_final_g_spacing_style=num_final_g_spacing_style,
    #         num_char_fc=num_char_fc,
    ...
    #         window=window,
    #         small=small,
    # # ---- added VGG backbone parameters ----
    #         use_vgg19bn=True,
    #         vgg_weights_path='/home/woody/iwi5/iwi5333h/model/vgg19_bn-c79401a0.pth',
    #         freeze_to_block=1,
    #         bn_eval_early=True
    #         )
